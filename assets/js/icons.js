...
window.ICONS = (function () {
  ...
  var S = {
    ...
    "grape":            '<path d="M12 6.5V3.5"/><path d="M12 3.5c1.5 0 2.5-.7 3-1.5"/><circle cx="12" cy="9" r="2.3"/><circle cx="8.2" cy="12.5" r="2.3"/><circle cx="15.8" cy="12.5" r="2.3"/><circle cx="12" cy="16" r="2.3"/><circle cx="6" cy="18" r="2.3"/><circle cx="18" cy="18" r="2.3"/>',
    "chevron-left":     '<path d="m14.5 5-7 7 7 7"/>',
    "layers":           '<path d="m12 2.5 9 5-9 5-9-5 9-5Z"/><path d="m3 12.5 9 5 9-5"/><path d="m3 17 9 5 9-5"/>',
